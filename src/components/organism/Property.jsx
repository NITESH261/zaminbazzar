                        ...
                        <div className="flex xl:grid xl:grid-cols-4 gap-4 w-fit xl:w-full">
                            {cards.map((card) => (
                                <Link
                                    key={card}
                                    href={"/"}
                                    className="w-80 xl:w-full group relative aspect-[3/2] bg-cover rounded-lg flex bg-[url('/assets/house/house1.webp')]"
                                >
                                    <div className="flex w-full p-4 bg-gradient-to-b from-black/40 to-transparent rounded-lg">
                                        <div className="flex w-full items-center h-fit justify-between">
                                            <strong className="text-white group-hover:underline">
                                                New listing
                                            </strong>
                                            <Badge className="h-fit bg-white text-neutral-700">
                                                296
                                            </Badge>
                                        </div>
                                    </div>
