        ...
        <>
            <div className="w-full h-96 md:mb-14 flex items-center justify-center relative">
                ...
                <div className="absolute flex flex-col gap-6 items-center px-4 justify-center h-full w-full bg-black/25">
                    ...
                    <div className="flex absolute top-1/2 md:top-[85%] shadow-md flex-col divide-y w-[90%] sm:w-full max-w-3xl md:bg-white rounded-2xl md:border md:border-gray-200">
