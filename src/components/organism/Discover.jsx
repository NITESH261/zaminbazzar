                ...
                <div className="flex flex-col gap-4 w-full max-w-7xl mx-auto px-4 py-4 md:py-6 lg:py-8">
                    ...
                    <div className="flex w-full overflow-x-hidden">
                        <Tabs defaultValue='buying' className='space-y-6 md:space-y-8'>
                            ...
                            <TabsContent value="buying" className="w-full overflow-hidden">
                                <div className="flex w-full overflow-x-auto pb-3 scrollbar">
                                    <div className="flex lg:grid lg:grid-cols-3 w-fit gap-4">
                                        {cards.map(card =>
                                            <Card key={card} className="w-80 lg:w-full">
                                                <CardHeader>
                                                    <CardTitle className="text-sm font-semibold">
                                                        <div className="flex w-full justify-between">
                                                            <span>Find out how much you can afford</span>
                            ...
                            <TabsContent value="renting" className="w-full overflow-hidden">
                                <div className="flex w-full overflow-x-auto pb-3 scrollbar">
                                    <div className="flex lg:grid lg:grid-cols-3 w-fit gap-4">
                                        {cards.map(card =>
                                            <Card key={card} className="w-80 lg:w-full">
                            ...
                            <TabsContent value="selling" className="w-full overflow-hidden">
                                <div className="flex w-full overflow-x-auto pb-3 scrollbar">
                                    <div className="flex lg:grid lg:grid-cols-3 w-fit gap-4">
                                        {cards.map(card =>
                                            <Card key={card} className="w-80 lg:w-full">
