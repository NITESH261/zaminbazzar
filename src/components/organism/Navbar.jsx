...
const Navbar = () => {
    return (
        <div className="flex sticky top-0 z-20 w-full bg-[#0078DB] border-b border-[#0078DB]">
            <div className="flex w-full h-16 items-center max-w-7xl mx-auto gap-4 px-4">
                            ...
                            {NavData.map((item, index) => (
                                item.data ?
                                    (<li key={index} className='navlink w-fit h-full items-center  flex group border-b-2 border-transparent hover:border-black transition-all'>
                                        <Link href={"/"} className='flex w-full text-base  pt-1.5 px-2 text-white transition-all group-hover:font-medium group-hover:text-[#964B00]' >{item.label}</Link>
                ...
                <div className="flex flex-grow text-white items-center gap-4 justify-end">
