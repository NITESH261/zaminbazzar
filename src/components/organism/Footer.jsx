        ...
        <div className="bg-gray-100 text-gray-800 w-full">
            ...
            <div className="bg-gray-300 py-4">
                <div className="container mx-auto text-center text-sm text-gray-600">
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestias rerum pariatur eos beatae quidem architecto, sit odit veniam illo mollitia, tempore qui. Atque qui sapiente minima dolorem. Aspernatur, accusamus odio.</p>
                </div>
            </div>
